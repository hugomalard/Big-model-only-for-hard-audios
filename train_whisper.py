...
if __name__ == "__main__":
    ...
    # Dataset prep (parsing CommonVoice)
    ...
    # Infering all the datasets
    asr_brain.hparams.wer_file = hparams["output_folder"] + "/test_wer.txt"
    asr_brain.evaluate(
        test_data,
        min_key="WER",
    ...
    asr_brain.hparams.wer_file = hparams["output_folder"] + "/dev_wer.txt"
    asr_brain.evaluate(
        valid_data,
        min_key="WER",
        test_loader_kwargs=hparams["test_loader_kwargs"],
    ...
    asr_brain.hparams.wer_file = hparams["output_folder"] + "/train_wer.txt"
    asr_brain.evaluate(
        train_data,
        min_key="WER",
        test_loader_kwargs=hparams["test_loader_kwargs"],
